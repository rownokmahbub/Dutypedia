...
const CalendarView = ({ workingTime, t47 }) => {
  return (
    <>
      <div className="shadow-3xl hidden sm:block h-max bg-white rounded-xl overflow-hidden p-4">
        <p className="text-center capitalize">company calender</p>
        <div className="mt-4">
      ...
      <div className="block sm:hidden">
        <Accordion
          title={
            <div className="flex gap-2 items-center">
              ...
              <span className="text-base capitalize">company calender</span>
            </div>
          }
          contentBg="bg-white"
        ...
        >
          <div className="py-2">
            <div>
              <div className="flex justify-between px-8 border-b pb-2 mb-2">
                <p>Day</p>
                <p>Working Time</p>
              </div>
              {t47 ? (
