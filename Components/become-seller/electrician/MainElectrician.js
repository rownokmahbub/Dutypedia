...
import { ElectricianOptions } from "@lib/data/options/electrician";
...
const MainElectrician = ({ goNext, savedData }) => {
                ...
                category.multiple
                  ? setActiveComponents(
                      <MultipleOptionsViewer
                        defaultOptions={ElectricianOptions[category.key] || []}
...
export default MainElectrician;
