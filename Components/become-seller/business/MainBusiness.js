...
import { BusinessOptions } from "@lib/data/options/business";
...
const MainBusiness = ({ goNext, savedData }) => {
                ...
                category.multiple
                  ? setActiveComponents(
                      <MultipleOptionsViewer
                        defaultOptions={BusinessOptions[category.key] || []}
