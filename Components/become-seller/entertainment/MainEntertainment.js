...
import { EntertainmentOptions } from "@lib/data/options/entertainment";
...
const Categories = [
  {
    ...
    key: "VideographerServices",
    multiple: true,
  },
  {
    id: 2,
    title: "photographer services",
    key: "photographer services",
    multiple: true,
  },
  {
    id: 3,
...
const MainEntertainment = ({ goNext, savedData }) => {
     ...
     <img className="pt-2 cursor-pointer pb-4 w-[30px]" src="/Assets/icon/arrowleft.svg" alt="" />
      ...
      <div className="w-full rounded-xl overflow-hidden bg-white dark:bg-bg-200">
        <div className="relative w-full h-40 overflow-hidden">
          <Image
            src="/Assets/images/service/entertainment.jpg"
            layout="fill"
            objectFit="cover"
          />
        </div>
                ...
                category.multiple
                  ? setActiveComponents(
                      <MultipleOptionsViewer
                        defaultOptions={
                          EntertainmentOptions[category.key] || []
                        }
