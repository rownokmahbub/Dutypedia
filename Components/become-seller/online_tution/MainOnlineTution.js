...
import { OnlineTutionOptions } from "@lib/data/options/onlinetution";
...
const Categories = [
  ...
  {
    id: 4,
    title: "Social Sciences Tutoring",
    key: "SOCIALSCIENCESTUTORING",
  },
  ...
  },
  {
    id: 8,
    title: "Music Lesson",
    key: "OnlineMusicLessons",
    multiple: true,
  },
];
const MainOnlineTution = ({ goNext, savedData }) => {
    ...
    <div className="container max-w-4xl mx-auto">
      <div className="w-full rounded-xl overflow-hidden bg-white">
        <div className="relative w-full h-40 overflow-hidden">
          <Image
            src="/Assets/images/service/onlinetution.jpg"
            layout="fill"
            objectFit="cover"
          />
        </div>
                ...
                category.multiple
                  ? setActiveComponents(
                      <MultipleOptionsViewer
                        defaultOptions={OnlineTutionOptions[category.key] || []}
...
export default MainOnlineTution;
