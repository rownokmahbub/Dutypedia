...
import { LifeStyleOptions } from "@lib/data/options/lifestyle";
...
const MainLifeStyle = ({ goNext, savedData }) => {
                ...
                category.multiple
                  ? setActiveComponents(
                      <MultipleOptionsViewer
                        defaultOptions={LifeStyleOptions[category.key] || []}
