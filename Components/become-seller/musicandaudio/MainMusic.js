...
import { MusicAudioOptions } from "@lib/data/options/musicaudio";
...
const Categories = [
  ...
  },
  {
    ...
    key: "AudiobookProduction",
  },
  {
    id: 14,
    title: "Audio Ads Production",
    key: "AudioAdsProduction",
  },
  {
    id: 15,
    title: "Sound Design",
...
const MainMusic = ({ goNext, savedData }) => {
    ...
    <div className="container max-w-4xl mx-auto">
      <div className="w-full rounded-xl overflow-hidden bg-white">
        <div className="relative w-full h-40 overflow-hidden">
          <Image
            src="/Assets/images/service/musicaudio.jpg"
            layout="fill"
            objectFit="cover"
          />
        </div>
                ...
                category.multiple
                  ? setActiveComponents(
                      <MultipleOptionsViewer
                        defaultOptions={MusicAudioOptions[category.key] || []}
