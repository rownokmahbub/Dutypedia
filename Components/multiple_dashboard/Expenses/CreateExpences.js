...
const CreateExpences = ({ closeModal }) => {
  ...
  const validate = Yup.object({
    ...
    amount: Yup.number().min(1).max(99999999).required("Required"),
    date: Yup.string().min(0).max(200).required("Required"),
  });
          ...
          <div className="flex flex-col md:flex-row justify-around">
            <div className="flex flex-col">
              ...
              <div className="flex gap-5 mt-8">
                <button
                  type="submit"
                  className={`btn btn-primary font-normal capitalize hover:text-white hover:bg-primary-300 w-32 ${
                ...
                <a
                  onClick={closeModal}
                  className="btn bg-white font-normal  text-primary border-primary capitalize hover:text-white hover:bg-primary-300 w-32"
                >
                  cancel
                </a>
              </div>
            ...
            <div className="space-y-3 max-w-sm">
              <p className="font-normal text-xl md:text-3xl mt-4">
                {" "}
                Instruction:
              </p>
            ...
            <div className="flex justify-end py-7 gap-5 md:hidden">
              <button
                type="submit"
                className="btn btn-primary font-normal px-12"
              >
                Next
              </button>
