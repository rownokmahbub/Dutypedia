...
const ExpenceCreate = ({goNext}) => {
  return (
    ...
    <div onClick={()=>{goNext()}} className="container max-w-screen-xl mx-auto relative flex flex-col justify-center items-center  mt-16 h-[256px] rounded-2xl shadow-4xl md:shadow-3xl ">
