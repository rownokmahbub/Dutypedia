...
<button onClick={openModal} className="container max-w-screen-xl mx-auto relative flex flex-col justify-center items-center  h-[256px] rounded-2xl shadow-4xl md:shadow-3xl bg-white md:mt-20">
