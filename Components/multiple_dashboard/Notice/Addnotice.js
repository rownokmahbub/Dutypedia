...
function Addnotice({goNext}) {
  return (
    ...
    <div className="container max-w-screen-xl mx-auto relative dark:bg-bg">
      <div className=" flex justify-between w-full visible md:invisible dark:bg-bg-200">
      ...
      <div>
        <div className=" flex justify-center items-center mt-20   h-[326px] rounded-2xl shadow-4xl md:shadow-3xl bg-white dark:bg-bg-300">
          ...
          <div className="flex flex-auto justify-center items-center static outline-none border-none">
            ...
            <button onClick={()=>{goNext()}} className="flex justify-center absolute w-[220px] outline-none border-none bg-transparent ">
              <Image className="cursor-pointer" src={plus} width={36} height={36} alt='plus' />
              <span className="ml-3 capitalize text-center text-lg text-[#666666] outline-none border-none bg-transparent cursor-pointer dark:text-gray-300">add new notice</span>
            </button>
          </div>
