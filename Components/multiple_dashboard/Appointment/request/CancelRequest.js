...
function CancelRequest() {
  return (
    <div>
         <div className="container md:max-w-screen-lg w-full  mx-auto relative min-h-[1400px] md:h-auto">
      <div className="  mt-16  rounded-2xl shadow-4xl md:shadow-3xl bg-white ">
       <AppoinmentHeader></AppoinmentHeader>
         <div className="md:min-h-screen mt-12 w-[96%] mx-auto pb-5">
          <div className="flex flex-col  rounded-2xl shadow-4xl md:shadow-3xl bg-white  h-auto pb-5">
