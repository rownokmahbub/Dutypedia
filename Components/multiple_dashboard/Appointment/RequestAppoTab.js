...
import ReceiveAppoDashboard from "./ReceiveAppo";
import SentAppoDashboard from "./SentAppo";

const RequestAppoTab = ({ searchTerm }) => {
  const Tabs = [
    {
      name: "Sent",
      content: <SentAppoDashboard searchTerm={searchTerm} />,
    },
    {
      name: "Receive",
      content: <ReceiveAppoDashboard searchTerm={searchTerm} />,
    },
  ];
  return (
    <Tab.Group>
