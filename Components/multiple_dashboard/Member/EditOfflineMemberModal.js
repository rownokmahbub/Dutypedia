        ...
        <Dialog onClose={() => {}} as="div" className="relative z-50">
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl dark:bg-bg bg-white dark:text-white text-left align-middle shadow-xl transition-all">
                  <div className="">
                    <div>
