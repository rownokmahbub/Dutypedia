...
const Cta = () => {
  return (
    <div className="bg-[#fafafa] dark:bg-[#272727] container mx-auto max-w-screen-xl -mb-7">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div className="flex flex-col">
          <p className="md:text-3xl text-[20px] font-bold dark:text-white">
            Hello Good Morning Find Service <br className="hidden md:block" /> What You Need
          </p>
